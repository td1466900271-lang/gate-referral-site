...
HOME = {
    "zh-cn": {
        "title": "GateAffiliate 40% 返佣邀请码 VLYQB1HXUW | 最高 14400U 奖励",
        "desc": "GateAffiliate 返佣站：使用 Gate 邀请码 VLYQB1HXUW 注册，交易最高享 40% 返佣，并有机会获得最高 14400U 活动奖励。实际权益以 Gate 官方页面为准。",
        "eyebrow": f"GateAffiliate 邀请码：{CODE}",
        "h1": "交易最高享 40% 返佣，最高可拿 14400U 奖励。",
        "copy": f"复制邀请码 {CODE}，通过 Gate 官方注册入口开通账户。注册后参与符合条件的交易活动，有机会享受最高 40% 返佣和最高 14400U 奖励，具体资格以 Gate 官方页面显示为准。",
        "open": "打开 Gate 注册",
        "copy_code": "复制邀请码",
        "stats": [("40%", "交易最高返佣"), ("14400U", "最高活动奖励"), ("VLYQB1HXUW", "注册邀请码")],
        "bonus_h2": "复制邀请码，交易最高享 40% 返佣。",
        "bonus_p": f"如果 Gate 注册页没有自动带入邀请码，请手动填写 {CODE}。返佣比例、最高 14400U 奖励、任务券、affiliate 资格和活动门槛会随官方活动变化，实际权益请以 Gate 当前页面显示为准。",
        ...
        "seo_h2": "Gate 40% 返佣与 14400U 奖励指南",
        "seo_p": "在注册前了解邀请码、最高 40% 返佣、最高 14400U 奖励、账户安全和市场信息，能帮助你更好地判断是否适合使用 Gate 的相关交易产品。",
        "latest_h2": "最新 GateAffiliate 市场日报",
        "latest_p": "每日市场日报覆盖 BTC、ETH、热门板块、宏观变量和交易情绪，方便你在交易前快速了解当天市场背景。",
        "faq_h2": "常见问题",
        "faq_p": "注册前建议先把这些细节确认好。",
        "faq": [("GateAffiliate 邀请码是多少？", f"邀请码是 {CODE}。如果注册链接没有自动带入，请手动复制填写。"), ("40% 返佣和 14400U 奖励一定能拿到吗？", "不承诺。不同地区、账户状态、活动周期、交易产品、交易量和 KYC 情况都可能影响资格，最终以 Gate 官方页面和账户内显示为准。"), ("注册后怎么确认邀请码和权益？", "完成注册后，可以到 Gate 账户内与邀请、奖励或 affiliate 相关的页面查看状态。如果页面没有显示，请以 Gate 账户内当前提示和官方规则为准。")],
    },
    "zh-hant": {},
    "en": {
        "title": "GateAffiliate 40% Rebate Code VLYQB1HXUW | Up to 14,400U Rewards",
        "desc": "Use Gate invite code VLYQB1HXUW to join through GateAffiliate, trade with up to 40% rebates, and qualify for up to 14,400U in campaign rewards. Final terms follow Gate's official page.",
        "eyebrow": f"GateAffiliate invite code: {CODE}",
        "h1": "Trade with up to 40% rebates and up to 14,400U in rewards.",
        "copy": f"Copy invite code {CODE} and open a Gate account through the official registration path. Eligible users may receive up to 40% trading rebates and up to 14,400U in campaign rewards, subject to Gate's current official terms.",
        "open": "Open Gate registration",
        "copy_code": "Copy invite code",
        "stats": [("40%", "Max trading rebate"), ("14,400U", "Max campaign rewards"), ("VLYQB1HXUW", "Invite code")],
        "bonus_h2": "Copy the code for up to 40% trading rebates.",
        "bonus_p": f"If Gate does not auto-fill the invite code, enter {CODE} manually. Rebate rates, up to 14,400U rewards, task coupons, affiliate eligibility, and campaign rules can change, so the current Gate page controls the final terms.",
        ...
        "seo_h2": "Gate 40% rebate and 14,400U reward guide",
        "seo_p": "Before signing up, review the invite code, up to 40% rebate, up to 14,400U rewards, account security basics, and market information so you can decide whether Gate products fit your needs.",
        ...
        "faq": [("What is the GateAffiliate invite code?", f"The invite code is {CODE}. If the signup page does not auto-fill it, copy and enter it manually."), ("Are the 40% rebate and 14,400U rewards guaranteed?", "No. Region, account status, campaign dates, trading product, trading volume, and KYC status may affect eligibility. Gate's current official page and account display are final."), ("How do I confirm the invite code after signup?", "After creating your account, check Gate's invite, rewards, or affiliate-related account pages. If the code or rewards do not appear, follow the current instructions shown inside your Gate account.")],
    },
    "ru": {
        "title": "GateAffiliate код VLYQB1HXUW | До 40% rebate и до 14,400U бонусов",
        "desc": "Используйте инвайт-код Gate VLYQB1HXUW через GateAffiliate: торгуйте с rebate до 40% и возможностью получить до 14,400U в рамках кампаний. Финальные условия определяет Gate.",
        "eyebrow": f"GateAffiliate инвайт-код: {CODE}",
        "h1": "Торгуйте с rebate до 40% и бонусами до 14,400U.",
        "copy": f"Скопируйте инвайт-код {CODE} и откройте аккаунт Gate через официальный путь регистрации. Подходящие пользователи могут получить rebate до 40% и бонусы кампаний до 14,400U; финальные условия зависят от текущей страницы Gate.",
        "open": "Открыть регистрацию Gate",
        "copy_code": "Скопировать код",
        "stats": [("40%", "Максимальный rebate"), ("14,400U", "Максимальные бонусы"), ("VLYQB1HXUW", "Инвайт-код")],
        "bonus_h2": "Скопируйте код для rebate до 40%.",
        "bonus_p": f"Если Gate не подставит код автоматически, введите {CODE} вручную. Rebate, бонусы до 14,400U, купоны, affiliate-право и условия кампаний могут меняться; финальные условия определяются текущей страницей Gate.",
        ...
        "seo_h2": "Гид по Gate rebate 40% и бонусам 14,400U",
        "seo_p": "Перед регистрацией проверьте инвайт-код, rebate до 40%, бонусы до 14,400U, базовую безопасность аккаунта и рыночную информацию, чтобы понять, подходят ли вам продукты Gate.",
        ...
        "faq": [("Какой инвайт-код GateAffiliate?", f"Инвайт-код: {CODE}. Если он не подставился автоматически, скопируйте и введите его вручную."), ("Гарантированы ли rebate 40% и бонусы 14,400U?", "Нет. Регион, статус аккаунта, даты кампании, торговый продукт, торговый объем и KYC могут влиять на eligibility. Финальными являются текущие условия Gate."), ("Как проверить инвайт-код после регистрации?", "После создания аккаунта проверьте разделы Gate, связанные с приглашениями, наградами или affiliate. Если код или бонусы не отображаются, следуйте актуальным подсказкам внутри аккаунта Gate.")],
    },
}
HOME["zh-hant"] = {
...
HOME["zh-hant"].update({
    "title": "GateAffiliate 40% 返佣邀請碼 VLYQB1HXUW | 最高 14400U 獎勵",
    "desc": "GateAffiliate 返佣站：使用 Gate 邀請碼 VLYQB1HXUW 註冊，交易最高享 40% 返佣，並有機會獲得最高 14400U 活動獎勵。實際權益以 Gate 官方頁面為準。",
    "eyebrow": f"GateAffiliate 邀請碼：{CODE}",
    "h1": "交易最高享 40% 返佣，最高可拿 14400U 獎勵。",
    "copy": f"複製邀請碼 {CODE}，透過 Gate 官方註冊入口開通帳戶。註冊後參與符合條件的交易活動，有機會享受最高 40% 返佣和最高 14400U 獎勵，具體資格以 Gate 官方頁面顯示為準。",
    "open": "打開 Gate 註冊",
    "copy_code": "複製邀請碼",
    "stats": [("40%", "交易最高返佣"), ("14400U", "最高活動獎勵"), ("VLYQB1HXUW", "註冊邀請碼")],
    "bonus_h2": "複製邀請碼，交易最高享 40% 返佣。",
    "bonus_p": f"如果 Gate 註冊頁沒有自動帶入邀請碼，請手動填寫 {CODE}。返佣比例、最高 14400U 獎勵、任務券、affiliate 資格和活動門檻會隨官方活動變化，實際權益請以 Gate 當前頁面顯示為準。",
    ...
    "seo_h2": "Gate 40% 返佣與 14400U 獎勵指南",
    "seo_p": "在註冊前了解邀請碼、最高 40% 返佣、最高 14400U 獎勵、帳戶安全和市場資訊，能幫助你更好地判斷是否適合使用 Gate 的相關交易產品。",
    "latest_h2": "最新 GateAffiliate 市場日報",
    "latest_p": "每日市場日報覆蓋 BTC、ETH、熱門板塊、宏觀變量和交易情緒，方便你在交易前快速了解當天市場背景。",
    "faq_h2": "常見問題",
    "faq_p": "註冊前建議先把這些細節確認好。",
    "faq": [("GateAffiliate 邀請碼是多少？", f"邀請碼是 {CODE}。如果註冊連結沒有自動帶入，請手動複製填寫。"), ("40% 返佣和 14400U 獎勵一定能拿到嗎？", "不承諾。不同地區、帳戶狀態、活動週期、交易產品、交易量和 KYC 情況都可能影響資格，最終以 Gate 官方頁面和帳戶內顯示為準。"), ("註冊後怎麼確認邀請碼和權益？", "完成註冊後，可到 Gate 帳戶內與邀請、獎勵或 affiliate 相關的頁面查看狀態。如果頁面沒有顯示，請以 Gate 帳戶內當前提示和官方規則為準。")],
})
